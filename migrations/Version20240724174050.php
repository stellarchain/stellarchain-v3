 ...
 */
final class Version20240724174050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_category (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
