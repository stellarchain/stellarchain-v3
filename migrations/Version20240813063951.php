...
final class Version20240813063951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE asset_metric (id INT NOT NULL, asset_id INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, price NUMERIC(65, 18) NOT NULL, volume_24h NUMERIC(65, 18) NOT NULL, circulating_supply NUMERIC(65, 18) NOT NULL, price_change_1h NUMERIC(20, 2) NOT NULL, price_change_24h NUMERIC(20, 2) NOT NULL, price_change_7d NUMERIC(20, 2) NOT NULL, PRIMARY KEY(id))');
